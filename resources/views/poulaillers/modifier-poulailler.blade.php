                                            ...
                                            <form  action="{{route('Poulailler.update',$poulailler->id)}}" method="POST">
                                                ...
                                                <div class="row g-3">
                                                    <div class="col">
                                                        ...
                                                        <input type="hidden" name="id" value="{{$poulailler->id}}">
                                                        <input type="text" name="nom" value="{{$poulailler->nom}}"  class="form-control" placeholder="Nom" aria-label="First name">
                                                    </div>
                                                    <div class="col">
                                                        <label class="form-label">lieu</label>
                                                        <input type="text" name="lieu" value="{{$poulailler->lieu}}" class="form-control" placeholder="lieu" aria-label="Last name">
                                                        {{-- <input type="hidden" name="poulailler_id" value="{{  $poulailler->id }}"> --}}
                                                    </div>
                                                   <div class="col">
                                                    <div class="form-group">
                                                        <label for="exampleFormControlSelect1">le gérant</label>
                                                        <select class="form-control" id="exampleFormControlSelect1" name='gerant_id'>
